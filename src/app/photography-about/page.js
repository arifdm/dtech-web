                ...
                <div className="rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                    <div className="md:flex items-center">
                        <div className="relative md:shrink-0">
                            <Image
                                src="/images/photography/about.jpg"
                                width={0}
                                height={0}
                                className="h-full w-full object-cover lg:w-[500px] md:w-80 lg:h-full md:h-96"
                                alt=""
                                sizes='100vw'
                                style={{
                                    width:"100%",
                    ...
                    return (
                        <div className="mx-auto" key={index}>
                            <Image
                                ...
                                width={0}
                                height={0}
                                className="size-[110px] grayscale hover:grayscale-0 duration-500 ease-in-out"
                                alt=""
                                sizes='100vw'
                                style={{
                                    width:"100%",
