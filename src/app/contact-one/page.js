...
export default function ContactOne() {
  return (
    <>
      ...
      <section
        className="relative table w-full bg-center bg-no-repeat bg-cover py-36"
      ...
      >
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 mt-10 text-center">
            <h3 className="text-3xl font-medium leading-normal tracking-wide text-white md:text-4xl md:leading-normal">
              Contact Us
            </h3>
          </div>
        </div>
