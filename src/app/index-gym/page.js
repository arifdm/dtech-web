...
export default function IndexGym() {
  ...
  return (
    <>
      ...
      <section
        className="flex md:h-screen py-36 items-center bg-center bg-no-repeat bg-cover"
        style={{ backgroundImage: "url('/images/gym/bg1.jpg')" }}
      >
            ...
            <div className="md:col-span-7">
              <div className="lg:ms-4">
                ...
                <h4 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
                  Introducing Techwind, <br /> A Fitness Center
                </h4>
                <p className="text-slate-400 max-w-xl">
                  Push your fitness further with our mix of facilities and We
                  will support you with advice on new and better ways to train.
                </p>
            ...
            <div className="filters-group-wrap text-center">
              <div className="filters-group">
                <ul className="mb-0 list-none container-filter filter-options">
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "all" ? "active" : ""}`}
                    data-group="all"
                  ...
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "monday" ? "active" : ""}`}
                    data-group="monday"
                  ...
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "tuesday" ? "active" : ""}`}
                    data-group="tuesday"
                  ...
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "wednesday" ? "active" : ""}`}
                  ...
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "thursday" ? "active" : ""}`}
                    data-group="thursday"
                  ...
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "friday" ? "active" : ""}`}
                    data-group="friday"
                  ...
                  <li
                    className={`inline-block font-medium text-lg mx-2 mb-3 cursor-pointer relative text-slate-400 transition duration-500 ${selectedGroup === "saturday" ? "active" : ""}`}
                    data-group="saturday"
      ...
      <section
        className="py-20 w-full table relative bg-center bg-no-repeat bg-fixed bg-cover"
        style={{ backgroundImage: "url('/images/gym/cta.jpg')" }}
      >
