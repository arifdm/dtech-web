    ...
    <>
      ...
      <section
        ...
        style={{
          ...
          backgroundImage: `url('/images/cafe/bg1.jpg')`,
        }}
      >
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 mt-10 text-center">
            <div className="md:-rotate-12 -rotate-6">
              <span className="font-kaushan text-white/70 block mb-2">
                Since 1993
              </span>
              <span className="font-kaushan text-white lg:text-9xl lg:leading-tight md:text-8xl md:leading-tight text-6xl leading-tight block">
        ...
        <div className="container relative">
          ...
          <div className="grid lg:grid-cols-12 md:grid-cols-12 grid-cols-1 mt-8 gap-[30px] items-center">
            <div className="lg:col-span-4 md:col-span-6 lg:order-1 order-2">
              <div className="grid grid-cols-1 gap-[30px]">
                <div className="group transition-all duration-500 ease-in-out md:text-end text-start">
                  <Image
                    src="/images/cafe/icons/coffee-time.svg"
                    width={64}
                    height={64}
                  ...
                  <div className="mt-2 md:order-1 order-2">
                    <Link
                      href="#"
                      className="text-xl font-semibold font-eb_garamond hover:text-indigo-600"
                    >
                      High Quality
                    </Link>
                ...
                <div className="group transition-all duration-500 ease-in-out md:text-end text-start">
                  <Image
                    src="/images/cafe/icons/coffee-beans.svg"
                    width={64}
                    height={64}
                    className="size-16 md:ms-auto p-3 rounded-full shadow-md dark:shadow-gray-800 bg-white"
                    alt=""
            ...
            <div className="lg:col-span-4 md:col-span-12 lg:order-2 order-1">
              <Image
                src="/images/cafe/cafe-services.png"
                width={0}
                height={0}
            ...
            <div className="lg:col-span-4 md:col-span-6 order-3">
              <div className="grid grid-cols-1 gap-[30px]">
                <div className="group transition-all duration-500 ease-in-out">
                  <Image
                    src="/images/cafe/icons/coffee.svg"
                    width={64}
                    height={64}
                ...
                <div className="group transition-all duration-500 ease-in-out">
                  <Image
                    src="/images/cafe/icons/drip-glass.svg"
                    width={64}
                    height={64}
                    className="size-16 p-3 rounded-full shadow-md dark:shadow-gray-800 bg-white"
                    alt=""
                ...
                <div className="group transition-all duration-500 ease-in-out">
                  <Image
                    src="/images/cafe/icons/coffee-cup.svg"
                    width={64}
                    height={64}
                    className="size-16 p-3 rounded-full shadow-md dark:shadow-gray-800 bg-white"
                    alt=""
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/cafe/cta.jpg')" }}
      >
        <div className="container relative">
          <div className="md:flex justify-end">
            <div className="md:w-1/2 md:py-36 py-10 lg:px-16 md:px-10 px-6 bg-white dark:bg-slate-900 text-center">
              ...
              <p className="text-indigo-600 font-eb_garamond text-lg font-medium mt-2">
                Starts at 3pm
              </p>
                ...
                <div className="flex " key={index}>
                  ...
                  <div className="ms-3 w-full">
                    <div className="flex justify-between pb-2 border-b border-gray-100 dark:border-gray-800">
                      <Link
                        href="#"
                        className="font-eb_garamond hover:text-indigo-600 text-xl font-semibold"
                      >
                        {data.name}
                      </Link>
                  ...
                  {clientsData.map((item, index) => (
                    <div className="tiny-slide" key={index}>
                      <div className="text-center">
                        <p className="text-lg text-slate-400 italic font-eb_garamond">
                          {item.description}{" "}
                        </p>
                        ...
                        <div className="text-center mt-5">
                          ...
                          />
                          <h6 className="mt-2 font-semibold font-eb_garamond text-lg">
                            {item.name}
                          </h6>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid md:grid-cols-2 gap-[30px] items-center">
            ...
            <div className="lg:ms-8">
              <h4 className="mb-4 md:text-4xl md:leading-normal text-3xl leading-normal font-eb_garamond font-medium">
                ...
                >
                  ...
                  <div className="content p-6">
                    <Link
                      ...
                      className="title h5 text-xl font-semibold font-eb_garamond hover:text-indigo-600 duration-500 ease-in-out"
                    >
                      {item.title}
                    </Link>
