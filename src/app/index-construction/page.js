            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                <div className="md:col-span-5">
                    <div className="relative">
                        <div className="pe-12">
                            <Image
                                src="/images/construction/ab01.jpg"
                                width={0}
                                height={0}
                        ...
                        <div className="absolute bottom-16 end-0">
                            <Image
                                src="/images/construction/ab02.jpg"
                                width={0}
                                height={0}
                                className="rounded-md rounded-ee-[30px] shadow-md w-56 h-56"
                                alt=""
                                sizes='100vw'
                                style={{
                                    width:"100%",
                ...
                {constructionProject.map((item,index)=>{
                    return (
                        <div className="group relative block overflow-hidden rounded-md transition-all duration-500" key={index}>
                            <Link href="/portfolio-detail-one"><Image
                                src={item.image}
                                width={0}
                                height={0}
