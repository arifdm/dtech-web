                  ...
                  <div className="absolute flex justify-between items-center bottom-16 md:start-10 -start-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-44 m-3">
                      <div className="flex items-center">
                          <Image
                              ...
                              width={56}
                              height={56}
                              className="size-14 rounded-full shadow-md dark:shadow-gray-800 me-3"
                              alt=""
                              style={{
                                  maxWidth: "100%",
                                  height: "auto"
              ...
              <div className="relative">
                  <div className="relative">
                      <Image
                          ...
                          width={384}
                          height={532}
                          className="mx-auto md:max-w-xs lg:max-w-sm rounded-lg shadow-md dark:shadow-gray-800"
                          alt=""
                          style={{
                              maxWidth: "100%",
                              height: "auto"
              ...
              <div className="lg:ms-8">
                  ...
                  <div className="pt-6 flex items-center border-t dark:border-gray-700">
                      <Image
                          ...
                          width={80}
                          height={80}
                          className="size-20 rounded-full shadow-md dark:shadow-gray-800 me-3"
                          alt=""
                          style={{
                              maxWidth: "100%",
                              height: "auto"
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
              <div className="relative order-1 md:order-2">
                      ...
                      <div className="col-span-6">
                          <div className="grid grid-cols-1 lg:gap-6 gap-4">
                              <Image
                                  ...
                                  width={0}
                                  height={0}
                                  className="shadow rounded-md lg:max-w-[240px] mx-auto"
                                  alt=""
                                  sizes="100vw"
                                  style={{
                                      width:"100%",
                  ...
                  <div className="absolute flex justify-between items-center md:bottom-16 bottom-0 end-5 rounded-lg shadow-md dark:shadow-gray-800 lg:w-72 w-48 m-3">
                      <Image
                          src="/images/sales-chart.jpg"
                          width={0}
                          height={0}
                          className="rounded-lg shadow dark:shadow-gray-800"
                          alt=""
                          sizes="100vw"
                          style={{
                              width:"100%",
