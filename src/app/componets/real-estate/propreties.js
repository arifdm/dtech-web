            ...
            <div className="md:flex mt-4">
                <div className="lg:w-1/2 md:w-1/2 p-1">
                    <div className="group relative overflow-hidden">
                        <Image
                            src="/images/real/property/single/1.jpg"
                            width={0}
                            height={0}
                            alt=""
                            sizes="100vw"
                ...
                <div className="lg:w-1/2 md:w-1/2">
                    <div className="flex">
                        <div className="w-1/2 p-1">
                            <div className="group relative overflow-hidden">
                                <Image
                                    src="/images/real/property/single/2.jpg"
                                    width={0}
                                    height={0}
                                    alt=""
                                    sizes="100vw"
                        ...
                        <div className="w-1/2 p-1">
                            <div className="group relative overflow-hidden">
                                <Image
                                    src="/images/real/property/single/3.jpg"
                                    width={0}
                                    height={0}
                                    alt=""
                                    sizes="100vw"
                    ...
                    <div className="flex">
                        <div className="w-1/2 p-1">
                            <div className="group relative overflow-hidden">
                                <Image
                                    src="/images/real/property/single/4.jpg"
                                    width={0}
                                    height={0}
                                    alt=""
                                    sizes="100vw"
                        ...
                        <div className="w-1/2 p-1">
                            <div className="group relative overflow-hidden">
                                <Image
                                    src="/images/real/property/single/5.jpg"
                                    width={0}
                                    height={0}
                                    alt=""
                                    sizes="100vw"
