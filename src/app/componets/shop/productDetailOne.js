            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-[30px] mt-4">
              <div className="flex items-center">
                ...
                <div className="space-x-1">
                  <Link
                    href="#"
                    className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"
                  >
                    S
                  </Link>
                  <Link
            ...
            >
              <li role="presentation">
                <button
                  ...
                  className={`${isOpenTab === 0 ? "text-white bg-indigo-600 hover:text-white" : ""} px-4 py-2 text-start font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out`}
                  id="dashboard-tab"
              ...
              <li role="presentation">
                <button
                  ...
                  className={`${isOpenTab === 1 ? "text-white bg-indigo-600 hover:text-white" : ""} px-4 py-2 text-start font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out`}
                  id="dashboard-tab"
                  data-tabs-target="#dashboard"
                  type="button"
                  role="tab"
              ...
              <li role="presentation">
                <button
                  ...
                  className={`${isOpenTab === 2 ? "text-white bg-indigo-600 hover:text-white" : ""} px-4 py-2 text-start font-semibold rounded-md w-full mt-3 hover:text-indigo-600 transition-all duration-500 ease-in-out`}
                  id="dashboard-tab"
                  data-tabs-target="#dashboard"
                  type="button"
                  role="tab"
            ...
            {isOpenTab === 0 ? (
              ...
              >
                <p className="text-slate-400">
                  ...
                  visual impact and readability of the typefaces (typography),
                  or the distribution of text on the page (layout or type area).
